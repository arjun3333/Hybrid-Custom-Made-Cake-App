                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          Text("0.5 lbs",style: TextStyle(fontSize: 42,
                                              color: Colors.brown,fontWeight: FontWeight.bold),),
                                          Divider(
                                            color: Colors.white10,
                                          ),
                                          Text("Serves 2-3 ",style: TextStyle(fontSize: 22,
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          Text("1 lbs",style: TextStyle(fontSize: 42,
                                              color: Colors.brown,fontWeight: FontWeight.bold),),
                                          Divider(
                                            color: Colors.white10,
                                          ),
                                          Text("Serves 4-6 ",style: TextStyle(fontSize: 22,
                                              color: Colors.brown,fontWeight: FontWeight.w600),)
                                        ],
                                      ),
                                    ),
